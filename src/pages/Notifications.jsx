...
const groupByDate = (notifs) => {
  ...
  notifs.forEach(n => {
    ...
    const label = ds === today
      ...
      : ds === yesterday
      ? "Kecha"
      : new Date(ms).toLocaleDateString("uz-UZ", { day: "2-digit", month: "long", year: "numeric" });
...
// cfg ni xavfsiz olish — bg field bo'lmasa fallback
const getCfg = (type) => {
  const base = NOTIF_TYPES[type] || NOTIF_TYPES.system;
  return {
    ...base,
    bg: base.bg ?? "#f9fafb",
  };
    ...
    <div style={{ flex: 1, display: "flex", flexDirection: "column", background: T.surface, overflow: "hidden" }}>
        ...
        <div style={{ display: "flex", gap: 14, alignItems: "flex-start" }}>
          ...
          <div>
            <div style={{
              ...
              border: `1px solid ${cfg.color}20`, display: "inline-block", marginBottom: 6,
            }}>{cfg.label}</div>
            <p style={{
      ...
      <div style={{ padding: "14px 28px", borderBottom: `1px solid ${T.border}` }}>
        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
          ...
          {notif.readAt && (
            <span style={{ fontSize: 11, color: T.muted }}>· {fmtFull(notif.readAt)}</span>
          )}
        </div>
      </div>
...
export default function Notifications() {
  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", fontFamily: T.fontBody, background: T.bg }}>
      <style>{`
      ...
      <div style={{
        ...
        <div style={{ padding: "0 6px 20px", borderBottom: "1px solid rgba(255,255,255,0.07)", marginBottom: 12 }}>
          ...
          <div style={{ marginTop: 6, display: "flex", alignItems: "baseline", gap: 8 }}>
            ...
            {unreadCount > 0 && (
              <span style={{ fontSize: 11, fontWeight: 700, color: "#fff", background: T.accent, borderRadius: 999, padding: "2px 8px" }}>
                {unreadCount} yangi
              </span>
            )}
          </div>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ display: "flex", background: T.bg, borderRadius: 8, border: `1px solid ${T.border}`, padding: 3 }}>
        ...
        <div style={{ flex: 1, overflowY: "auto" }}>
          ...
          {!loading && notifications.length === 0 && (
            <div style={{ padding: "80px 20px", textAlign: "center", animation: "fadeUp 0.3s ease" }}>
              ...
              <p style={{ fontSize: 13, color: T.muted, margin: 0 }}>Yangi xabarlar shu yerda ko'rinadi</p>
            </div>
          )}
